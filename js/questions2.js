...
function corregirSelect(respselect, pregselect, solselect) {
	...
	if (sel.selectedIndex == solselect) {
		...
		darRespuestaHtml(respselect + "Respuesta incorrecta", "red");
	}
}
...
function corregirMulti1(respmulti, pregmulti, solmulti) {
	...
	if (corr == solmulti.length) {
		darRespuestaHtml(respmulti + "Correcto", "green");
	}
	//***** intentar poner respuesta parcial******
	else {
		darRespuestaHtml(respmulti + "Respuesta incorrecta", "red");
	}
}
//Corregir checkbox
function corregirCheckbox(respchk, pregchk, solchk) {
	...
	if (corr == solchk.length) {
		darRespuestaHtml(respchk + "Correcto", "green");
	} else {
		darRespuestaHtml(respchk + "Respuesta incorrecta", "red");
	}
}
//Corregir radio
function corregirRadio(respradio, pregradio, solradio) {
	...
	if (r == solradio) {
		darRespuestaHtml(respradio + "Correcto", "green");
		nota += 1;
	} else {
		darRespuestaHtml(respradio + "Respuesta incorrecta", "red");
	}
}
//****************************************************************************************************************
